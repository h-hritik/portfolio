              ...
              <div className="card shadow project-card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    The Dental Clinic Management System (DCMS) is a robust software solution crafted using HTML/CSS for frontend design, Bootstrap for responsive layout, Java (servlet, JSP) for backend logic, and MySQL for database management. It is tailored to streamline the daily operations of dental clinics...
            ...
            <div className="col-md-4 my-3">
              <div className="card shadow project-card my-2">
                ...
                <div className="card-body">
                  ...
                  <a href="https://react-news-aihjjuth9-hritik-mauryas-projects.vercel.app/" className="btn btn-primary">View Project</a>
                </div>
              </div>
            </div>
          </div>
